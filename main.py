...
def run_bot():
    ...
    for symbol in symbols:
        ...
        for chat_id, u in users.items():
            ...
            if filter_type=="All Pairs" or (filter_type=="BTC Only" and symbol=="BTCUSDT") or (filter_type=="Altcoins Only" and symbol!="BTCUSDT") or (filter_type=="Signals VIP"):
                send_telegram(chat_id, f"🚀 AI CRYPTO SIGNAL 🚀\nPair: {symbol}\nSignal: {signal}\nEntry: {round(price,4)}\nTP: {round(tp,4)}\nSL: {round(sl,4)}\nTF: 15M")
